...
### Dependencies
- **React**: The code uses React for building the user interface and managing component state.
- **@heroicons/react**: This library provides icons used in the component for visual representation.
...
3. Selected files are displayed with their names and icons.
4. Error messages are shown if the file type is invalid or the maximum file count is exceeded.
